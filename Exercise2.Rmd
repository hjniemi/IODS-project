...
learning2014 <- lrn14 %>% select(any_of(keep_columns))
...
# change the name of "Points" to "points"
learning2014 <- learning2014 %>% rename("points" = "Points")
...
pairs(learning2014[-1], col=c("F"="red", "M"="blue")[unclass(learning2014$gender)])
